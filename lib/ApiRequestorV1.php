...
class ApiRequestorV1
{
     ...
     */
    public function __construct($apiAccessKey = null, $apiToken = null, $apiBase = null)
    {
     ...
     * @return array
     */
    private static function _defaultHeaders($apiAccessKey, $apiToken, $clientInfo = null)
    {
        $uaString = 'Telnyx/v1 PhpBindings/' . Telnyx::VERSION;
